...
CREATE TYPE "public"."report_status" AS ENUM('pending', 'dispatched', 'resolved', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('citizen', 'dispatcher', 'responder', 'admin');--> statement-breakpoint
